...
from .abstractbbdnet3 import AbstractBBDNet
...
class BBDNet7(WModule):
    ...
    def process_one_image(self,datas):
        ...
        if self.is_training:
            ...
            fboxes, flabels, probs, raw_plabels,_ = bbd_net.get_predict(raw_bboxes,threshold=self.threshold)
