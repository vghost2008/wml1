...
mod_category_index = {1:{"name":"rectangle"},2:{"name":"triangle"},3:{"name":"ellipse"}}
...
def register_all_coco(root="datasets"):
    #名字，tfrecord文件路径,解码函数，num_classes(不包含背景)
    SPLITS = [
        ("coco_2017_train", os.path.join(dataset_root_path,"coco_tfdata"),coco_get_data,90,coco_category_index),
