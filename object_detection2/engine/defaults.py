...
def default_argument_parser():
    ...
    parser.add_argument("--config-file", default=COCOCONFIG_DIR+"RetinaNet-waa.yaml", metavar="FILE", help="path to config file")
    #parser.add_argument("--config-file", default=COCOCONFIG_DIR+"EfficientDet-DR.yaml", metavar="FILE", help="path to config file")
    #parser.add_argument("--config-file", default=COCOCONFIG_DIR+"Mask-RCNN-FPN-C3-3.yaml", metavar="FILE", help="path to config file")
