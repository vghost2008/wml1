...
def default_argument_parser():
    ...
    #parser.add_argument("--config-file", default=COCOCONFIG_DIR+"RetinaNet_5.yaml", metavar="FILE", help="path to config file")
    parser.add_argument("--config-file", default=COCOCONFIG_DIR+"EfficientDet-D3.yaml", metavar="FILE", help="path to config file")
    parser.add_argument(
        "--resume",
        action="store_true",
